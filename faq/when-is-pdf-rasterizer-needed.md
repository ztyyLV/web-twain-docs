...
When you load/download a text-based PDF onto the viewer, you need the PDF Rasterizer Add-on. To detect whether a PDF file is text-based or not, you can use the API <a href="https://www.dynamsoft.com/web-twain/docs-archive/info/api/Addon_PDF.html?ver=17.2.1#istextbasedpdf" target="_blank">IsTextBasedPDF</a>.
