...
Please check here for more information: <a href="https://www.dynamsoft.com/web-twain/docs-archive/indepth/features/output.html?ver=17.2.1#http-with-the-file-uploader" target="_blank">HTTP with the File Uploader</a>.
