...
More information can be found here: <a href="https://www.dynamsoft.com/web-twain/docs-archive/v17.2.1/indepth/features/barcode.html#specify-the-barcode-types-to-read" target="_blank">Specfiy the Barcode Type(s) to Read</a>.
