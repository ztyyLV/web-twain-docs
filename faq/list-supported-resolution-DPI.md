...
1.  Use <a href="https://www.dynamsoft.com/web-twain/docs/info/api/WebTwain_Acquire.html?ver=latest#getcapabilities" target="_blank">getCapabilities</a> to get all capabilities of the current data source,
...
2. Call the following code to get all the resolutions supported by the scanner.
