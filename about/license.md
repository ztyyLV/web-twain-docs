...
**A**: The `DWT` license is set using the global API `Dynamsoft.WebTwainEnv.ProductKey`. For more information, please refer to the gon on how to [Update the License Key]({{site.indepth}}development/upgrade.html#update-the-license-key).
