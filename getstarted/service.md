...
The prompt comes up when you try to [create a WebTwain instance]({{site.indepth}}faqs/develop/how-can-i-customize-the-webtwain-instances.html) in Service mode.
